...
WORK_DIR = HERE.parent  # tools/ — skills live here as siblings
SYSTEMS_DIR = HERE.parents[1] / "systems"  # libraries + registry.yaml
...
def test_ds_validate_spec_valid():
    ...
    spec_path = str(SYSTEMS_DIR / "swiss" / "spec.yaml")
    library_root = str(SYSTEMS_DIR / "swiss")
...
def test_ds_check_compliance():
    ...
    components_dir = SYSTEMS_DIR / "swiss" / "components"
...
def test_ds_register_unregister_roundtrip():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            spec_dir = str(SYSTEMS_DIR / "swiss")
...
def test_ds_load_extends():
    ...
    import tempfile
    from design_system_skill.loader import clear_cache
    real_registry = SYSTEMS_DIR / "registry.yaml"
    with tempfile.TemporaryDirectory() as td:
        td_path = Path(td)
        temp_registry = td_path / "registry.yaml"
        shutil.copy2(real_registry, temp_registry)
        shutil.copytree(SYSTEMS_DIR / "terminal", td_path / "terminal")
